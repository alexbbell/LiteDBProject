...
namespace LiteDBProject.Controllers
{
    ...
    {
        private readonly IDbContext _liteDbContext;
        public PremixController(IDbContext liteDbContext)
        {
        ...
        public  async Task<IActionResult> GetAll()
        {
            ...
            IEnumerable<Premix> cols = _liteDbContext.GetPremix();
 ...
 //           Boolean apw = _liteDbContext.AddPremixWithVit();
        ...
        public Premix Get(int id)
        {
            ...
            Premix premix = _liteDbContext.GetPremix(id);
            return premix;
        }
